...
def get_anomaly_prediction():
    if request.method == 'POST':
        ...
        if cyber_prediction == 0:
            result= "normal"
        else:
            result= "anomaly"    

        return jsonify({'the cyber security prediction is': result})
        ...
        if cyber_prediction1 == 0:
            result1= "normal"
        else:
            result1= "anomaly"    
        return jsonify({'the cyber security prediction is': result1})
